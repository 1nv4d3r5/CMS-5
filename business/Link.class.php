...
class Link
{
	...
	public static function deactSubnav($value)
	{
		$link = '?type=subnav&action=deactivate&value=' . $value;
		return self::Build($link);
	}
	...
	public static function viewFeeds()
	{
		$link = '?type=feeds&action=generate';
		return self::Build($link);
		
	}
	
	public static function deleteFeed($value)
	{
		$link = '?type=feeds&action=del&value='.$value;
		return $link;
	}
	...
	public static function viewSubContent()
	{
		$link = '?type=sub_content&action=edit';
		return self::Build($link);
	}
	...
	public static function sendSubContent()
	{
		$link = '?type=sub_content&action=send';
		return self::Build($link);
	}
	...
	public static function addEditor() {
		$link = '?type=editor&action=add&value=1';
		return self::Build($link);
	}

	public static function editEditor() {
		$link = '?type=editor&action=edit&value=1';
		return self::Build($link);
	}
	
	public static function viewEditor() {
		$link = '?type=editor&action=generate&value=1';
		return self::Build($link);
	}
	
	public static function uploadEditor() {
		$link = '?type=editor&action=upload&value=0';
		return self::Build($link);
	}
}
?>
